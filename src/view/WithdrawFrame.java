...
public class WithdrawFrame extends JInternalFrame implements ActionListener{
    ...
    public WithdrawFrame(String title){
        ...
        updateBut = new JButton("Withdraw");
    ...
    public void actionPerformed(ActionEvent axnEve){
        ...
        if (obj==passPf){
            ...
            try {
                ...
                if(amt>bal){
                    JOptionPane.showMessageDialog(null, "Please Provide Amount Less Than Balance", "ERROR", JOptionPane.ERROR_MESSAGE);
                } else {
                    int option = JOptionPane.showConfirmDialog(null, "Withdraw From This Account", "CONFIRM", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (option == JOptionPane.YES_OPTION) {
                        ...
                        resetData();
                        if(Home.depositFrame.isShowing()){
                        DepositFrame.setData();
                    }
                    }
                }
            } catch (SQLException sqlExc) {
            ...
            Home.withdrawFrame.setVisible(false);
